...
# GPUComputePassTimestampWrites and GPURenderPassTimestampWrites both map to WGPUPassTimestampWrites in native.
GPUPassTimestampWrites = StructType("GPUPassTimestampWrites", [
